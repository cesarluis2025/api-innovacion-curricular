...
{
    private readonly IAspectoNormativoServicio _servicio;
    public AspectoNormativoController(IAspectoNormativoServicio servicio) => _servicio = servicio;
    ...
    [HttpPost]
    public async Task<IActionResult> Crear([FromBody] CrearAspectoNormativoPeticion peticion)
    {
        try
        {
    ...
    [HttpPut("{id}")]
    public async Task<IActionResult> Actualizar(int id, [FromBody] ActualizarAspectoNormativoPeticion peticion)
    {
